...
class OutboundPollResponse(object):
    ...
    def __init__(self, to=None, received_timestamp=None, sent_timestamp=None, status=None):
        """
        OutboundPollResponse - a model defined in Swagger
    ...
    def to(self):
        """
        Gets the to of this OutboundPollResponse.
        The phone number (recipient) the message was sent to (in E.164 format).

        :return: The to of this OutboundPollResponse.
        :rtype: str
        """
        return self._to
    ...
    def to(self, to):
        ...
        :param to: The to of this OutboundPollResponse.
        :type: str
        """
    ...
    def received_timestamp(self):
        """
        Gets the received_timestamp of this OutboundPollResponse.
        The date and time when the message was recieved by recipient.

        :return: The received_timestamp of this OutboundPollResponse.
        :rtype: str
        """
    ...
    def received_timestamp(self, received_timestamp):
        ...
        :param received_timestamp: The received_timestamp of this OutboundPollResponse.
        :type: str
        """
    ...
    def sent_timestamp(self):
        """
        Gets the sent_timestamp of this OutboundPollResponse.
        The date and time when the message was sent.

        :return: The sent_timestamp of this OutboundPollResponse.
        :rtype: str
        """
    ...
    def sent_timestamp(self, sent_timestamp):
        ...
        :param sent_timestamp: The sent_timestamp of this OutboundPollResponse.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this OutboundPollResponse.
        Delivery status of the message

        :return: The status of this OutboundPollResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this OutboundPollResponse.
        Delivery status of the message

        :param status: The status of this OutboundPollResponse.
        :type: str
        """
